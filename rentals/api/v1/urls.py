...
urlpatterns = [
    ...
    # Authenticated-user convenience endpoints
    path('users/me/', views.user_detail_me, name='user-detail-me'),
    path('users/me/profile/', views.profile_detail_me, name='profile-detail-me'),
    path('users/me/buildings/', views.user_buildings_me, name='user-buildings-me'),
